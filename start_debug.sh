#!/bin/bash
#
# DEBUG start script for ch.gov.uk
...
# Settings to allow remote debugging
export PERL5_DEBUG_ROLE="server"
export PERL5_DEBUG_HOST="0.0.0.0"
export PERL5_DEBUG_PORT="9988"

export PERL5LIB="${APP_DIR}/local/lib/perl5"
exec plenv exec perl -d:Camelcadedb "${APP_DIR}/script/start_app" daemon -l "http://*:${PORT}" "${APP_ARGS}"
